...
class _CustomPorfolioState extends State<CustomPorfolio> {
  ...
  void initState() {
    ...
    secondPersontypeController = TextEditingController(text: "SUB CONTRACTOR"); // default value
    secondPersonNoController = TextEditingController(text: "03214546737");      // default value
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            CustomTextFieldS(controller: customerNameController, title: "Customer Name and Address"),
            CustomTextFieldS(controller: customerContactNoController, title: "Customer Contact No", keyboardType: TextInputType.number),
            CustomTextFieldS(controller: secondPersontypeController, title: "Second Person Type"),
            CustomTextFieldS(controller: secondPersonNoController, title: "Second Person Number", keyboardType: TextInputType.number),
            CustomTextFieldS(controller: thirdPersonTypeController, title: "Third Person Type", readOnly: true),
            CustomTextFieldS(controller: thirdPersonNoController, title: "Third Person Number", keyboardType: TextInputType.number),
            CustomTextFieldS(controller: leadFromController, title: "Lead From"),
            CustomTextFieldS(controller: viaController, title: "Via"),
            SizedBox(height: 6),
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: AppFonts.styleHarmoniaBold14W600(Color(0xFFB31D1E)),
                    ),
                  ),
                  SizedBox(width: 10),
                  Row(
