class LeadGeneratedModel {
  ...
  factory LeadGeneratedModel.fromJson(Map<String, dynamic> json) {
    return LeadGeneratedModel(
  ...
  static List<LeadGeneratedModel> fromJsonList(List<dynamic> jsonList) {
    return jsonList.map((json) => LeadGeneratedModel.fromJson(json)).toList();
  }
}
