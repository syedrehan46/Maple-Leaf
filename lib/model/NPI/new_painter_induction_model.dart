class NewPainterInductionModel {
  final int? actualId;
  ...
  factory NewPainterInductionModel.fromJson(Map<String, dynamic> json) {
    return NewPainterInductionModel(
