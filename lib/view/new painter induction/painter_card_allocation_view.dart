...
class PainterCardAllocationView extends StatefulWidget {
  ...
  @override
  State<PainterCardAllocationView> createState() => _AddLeadsViewState();
}

class _AddLeadsViewState extends State<PainterCardAllocationView> {
  final TextEditingController painterNameEditingController = TextEditingController(text: "03232454646");
  final TextEditingController painterNumberEditingController = TextEditingController(text: "YFFUR");
