...
class GcInvesterSalesView extends StatelessWidget {
  const GcInvesterSalesView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            CustomerRetaileIntakerDesign(isShowFields: true,isShowFieldAndButton: true,isShowShops: false,isShowRegisteredNumber: false,)
               ],
        ),
      ),
    );
